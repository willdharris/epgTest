...
window.showPopup = function showPopup(clicked_id) {
  ...
  if (chanPop === `disc--popup`) {
    ...
    bigprimetime =
      document.getElementById(`big--ahc--${checkDate}--07:00 PM`) || ``;
    bigTopPos = bigprimetime.offsetTop;
    ...
    bigprimetime =
      document.getElementById(`big--apl--${checkDate}--07:00 PM`) || ``;
    bigTopPos = bigprimetime.offsetTop;
    ...
    bigprimetime =
      document.getElementById(`big--dam--${checkDate}--07:00 PM`) || ``;
    bigTopPos = bigprimetime.offsetTop;
    ...
    bigprimetime =
      document.getElementById(`big--dfc--${checkDate}--07:00 PM`) || ``;
    bigTopPos = bigprimetime.offsetTop;
    ...
    bigprimetime =
      document.getElementById(`big--idd--${checkDate}--07:00 PM`) || ``;
    bigTopPos = bigprimetime.offsetTop;
    ...
    bigprimetime =
      document.getElementById(`big--mtd--${checkDate}--07:00 PM`) || ``;
    bigTopPos = bigprimetime.offsetTop;
    ...
    bigprimetime =
      document.getElementById(`big--own--${checkDate}--07:00 PM`) || ``;
    bigTopPos = bigprimetime.offsetTop;
    ...
    bigprimetime =
      document.getElementById(`big--tlc--${checkDate}--07:00 PM`) || ``;
    bigTopPos = bigprimetime.offsetTop;
    ...
    bigprimetime =
      document.getElementById(`big--des--${checkDate}--07:00 PM`) || ``;
    bigTopPos = bigprimetime.offsetTop;
    ...
    bigprimetime =
      document.getElementById(`big--dsf--${checkDate}--07:00 PM`) || ``;
    bigTopPos = bigprimetime.offsetTop;
    ...
    bigprimetime =
      document.getElementById(`big--hgtv--${checkDate}--07:00 PM`) || ``;
    bigTopPos = bigprimetime.offsetTop;
    ...
    bigprimetime =
      document.getElementById(`big--cook--${checkDate}--07:00 PM`) || ``;
    bigTopPos = bigprimetime.offsetTop;
    ...
    bigprimetime =
      document.getElementById(`big--diy--${checkDate}--07:00 PM`) || ``;
    bigTopPos = bigprimetime.offsetTop;
    ...
    bigprimetime =
      document.getElementById(`big--food--${checkDate}--07:00 PM`) || ``;
    bigTopPos = bigprimetime.offsetTop;
    ...
    bigprimetime =
      document.getElementById(`big--trav--${checkDate}--07:00 PM`) || ``;
    bigTopPos = bigprimetime.offsetTop;
