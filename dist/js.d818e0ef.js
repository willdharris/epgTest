...
},{}],"src/js/creds.js":[function(require,module,exports) {
"use strict";
...
var user = "unclebillepg";
exports.user = user;
var password = "526D1A95E3B6B19651774D1F90A68C32D758858F";
exports.password = password;
},{}],"src/js/tok.js":[function(require,module,exports) {
"use strict";
...
function getTok() {
  return _getTok.apply(this, arguments);
}

function _getTok() {
  _getTok = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var stuff, getIT, newTok, jsonTok, taken;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 5;
            return fetch("https://cors-anywhere.herokuapp.com/https://json.schedulesdirect.org/20141201/token", getIT);

          case 5:
            newTok = _context.sent;
            _context.next = 8;
            return newTok.json();

          case 8:
            jsonTok = _context.sent;
            _context.next = 11;
            return jsonTok.token;

          case 11:
            taken = _context.sent;
            return _context.abrupt("return", taken);
...
},{"./creds.js":"src/js/creds.js"}],"src/js/index.js":[function(require,module,exports) {
"use strict";
...
var Schedule = /*#__PURE__*/function () {
  function Schedule(channel, stationID) {
  ...
  _createClass(Schedule, [{
    key: "getSchedule",
    value: function () {
      var _getSchedule = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        var _this = this;

        var curDate, today, yesterDate, yesterday, tomDate, tomorrow, plusTwoDate, todayPlusTwo, plusThreeDate, todayPlusThree, stationData, scheduleOptions, resSched, stationSchedule, todayArr, tmwArr, plusTwoArr, plusThreeArr, fullArr, todaySchedule, todayIDs, data, options, res, jsonData, todayTitles, loading, grid, checkDate, i, markup, popSched, detailMarkup, primetime, topPos, alerted;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
              ...
              case 23:
                ...
                _context.next = 28;
                return fetch("https://cors-anywhere.herokuapp.com/https://json.schedulesdirect.org/20141201/schedules", scheduleOptions);

              case 28:
                resSched = _context.sent;
                _context.next = 31;
                return resSched.json();

              case 31:
                stationSchedule = _context.sent;
                _context.next = 34;
                return stationSchedule[0].programs;

              case 34:
                todayArr = _context.sent;
                _context.next = 37;
                return stationSchedule[1].programs;

              case 37:
                tmwArr = _context.sent;
                _context.next = 40;
                return stationSchedule[2].programs;

              case 40:
                plusTwoArr = _context.sent;
                _context.next = 43;
                return stationSchedule[3].programs;

              case 43:
                plusThreeArr = _context.sent;
                //Combine each day to one array
                fullArr = todayArr.concat(tmwArr, plusTwoArr, plusThreeArr); //Get program IDs and map to air times

                _context.next = 47;
                return fullArr.map(function (elem) {
                  return {
                    id: elem.programID,
              ...
              case 47:
                todaySchedule = _context.sent;
                _context.next = 50;
                return todaySchedule.map(function (id) {
                  return id["id"];
                });

              case 50:
                todayIDs = _context.sent;
                data = todayIDs;
              ...
              case 55:
                ...
                _context.next = 60;
                return fetch("https://cors-anywhere.herokuapp.com/https://json.schedulesdirect.org/20141201/programs", options);
              ...
              case 63:
                ...
                todayTitles = jsonData.map(function (elem) {
                  return {
                    id: elem.programID,
                    ...
                    ssn: elem.hasOwnProperty("metadata") && elem.metadata[0].hasOwnProperty("Gracenote") ? "Season ".concat(elem.metadata[0].Gracenote.season) : "Season N/A",
                    epNum: elem.hasOwnProperty("metadata") && elem.metadata[0].hasOwnProperty("Gracenote") ? "Ep ".concat(elem.metadata[0].Gracenote.episode) : "Ep N/A"
                  };
                });
                /*** MATCH IDS ***/
                // Combine Schedules (ID, Times) with Corresponding Titles based on same ID

                Object.keys(todaySchedule).forEach(function (key) {
                  var existtodayTitles = todayTitles.find(function (_ref) {
                    var id = _ref.id;
                    return todaySchedule[key].id === id;
                  });
                ...
                loading = document.querySelector("#".concat(this.channel, "--epg .spinner"));
                loading.style.visibility = "hidden";
                /*** RENDER SCHEDULE ***/

                grid = document.getElementById("".concat(this.channel, "--epg"));
                checkDate = new Date().toLocaleDateString(undefined, {
                  weekday: "short",
                  day: "2-digit",
                  month: "2-digit"
                });
                ...
                for (i = 0; i < todaySchedule.length; i++) {
                  markup = "  \n                        <div class=\"cell time\"><p>".concat(todaySchedule[i].time, "</p>\n                        <p class=\"date\" id=\"").concat(this.channel, "--").concat(todaySchedule[i].day, "--").concat(todaySchedule[i].time, "\">").concat(todaySchedule[i].day, "</p></div>\n                        <div class=\"cell title\"><p class=\"series\">").concat(todaySchedule[i].series, "</p>\n                        <p class=\"episode\">").concat(todaySchedule[i].episode, "</p></div>                         ");
                  grid.insertAdjacentHTML("beforeend", markup);
                }

                popSched = document.getElementById("".concat(this.channel, "--popup"));

                for (i = 0; i < todaySchedule.length; i++) {
                  detailMarkup = "\n                        <div class=\"cell time\"><p>".concat(todaySchedule[i].time, "</p>\n                        <p class=\"date\" id=\"big--").concat(this.channel, "--").concat(todaySchedule[i].day, "--").concat(todaySchedule[i].time, "\">").concat(todaySchedule[i].day, "</p></div>\n                        <div class=\"bigCell title\"><p class=\"series\">").concat(todaySchedule[i].series, "</p>\n                        <p class=\"episode\">").concat(todaySchedule[i].episode, "</p><p class=\"tmsid\">").concat(todaySchedule[i].ssn, " ").concat(todaySchedule[i].epNum, " - ").concat(todaySchedule[i].id, "</p></div> ");
                  popSched.insertAdjacentHTML("beforeend", detailMarkup);
                }

                primetime = document.getElementById("".concat(this.channel, "--").concat(checkDate, "--07:00 PM")); // Make grids align to 7:00PM of current day (8:00PM visually)

                topPos = primetime.offsetTop;
                console.log(primetime, topPos);
                todaySchedule.forEach(function (el) {
                  return document.getElementById("".concat(_this.channel, "--epg")).scrollTop = topPos + 18;
                });
                _context.next = 83;
                break;
...
var disc = new Schedule("disc", "56905");
var ahc = new Schedule("ahc", "18284");
var apl = new Schedule("apl", "57394");
var dam = new Schedule("dam", "60468");
var dfc = new Schedule("dfc", "16618");
var idd = new Schedule("idd", "16615");
var mtd = new Schedule("mtd", "31046");
var own = new Schedule("own", "70388");
var tlc = new Schedule("tlc", "57391");
var des = new Schedule("des", "19247");
var dsf = new Schedule("dsf", "58428");
var hgtv = new Schedule("hgtv", "49788");
var cook = new Schedule("cook", "68065");
var diy = new Schedule("diy", "67375");
var food = new Schedule("food", "50747");
var trav = new Schedule("trav", "59303");
var chanArr = [disc, ahc, apl, dam, dfc, idd, mtd, own, tlc, des, dsf, hgtv, cook, diy, food, trav]; // Get token, test, fetch schedules

var currToken = _tok.default.then(function (result) {
  currToken = result;
